...
//		tableArgs2.add("showprogress=f");
		...
		final long outSize=kmersOut+numKept;
		
		//Append retained kmers to a file
		tables.dumpKmersAsBytes_MT(kmerFile, minCountToKeep, Integer.MAX_VALUE, false);
		...
		if(minCountToKeep>=1 && tables.readsIn>=1){
			...
			BBDukF.main(bbdukArgs.toArray(new String[0]));
		}
