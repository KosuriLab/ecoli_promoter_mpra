...
//	}
	...
	public synchronized void loadLongKmers(){
		...
		String fnameSSU=Data.findPath("?ssu_"+kLong+"mers.fa.gz");
		ssuKmers=loadLongKmers(fnameSSU, kLong);
		stats16S.kmerSet=ssuKmers;
		String fnameLSU=Data.findPath("?lsu_"+kLong+"mers.fa.gz");
		lsuKmers=loadLongKmers(fnameLSU, kLong);
		stats23S.kmerSet=lsuKmers;
	}
	
	private static IntHashSet loadLongKmers(String fname, int k){
