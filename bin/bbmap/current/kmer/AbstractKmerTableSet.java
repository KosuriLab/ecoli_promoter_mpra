...
//			outstream.println("Estimated valid kmers 4+: "+(long)filter[0].estimateUniqueKmers(prehashes, 4));
	...
	public abstract boolean dumpKmersAsBytes(String fname, int mincount, int maxcount, boolean printTime);
	public abstract boolean dumpKmersAsBytes_MT(String fname, int mincount, int maxcount, boolean printTime);
