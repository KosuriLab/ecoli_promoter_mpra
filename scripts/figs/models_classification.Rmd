...
```{r}
logistic <- read.table('../../processed_data/combined/20191114_kmer_logistic_predictions.txt',
...
```{r}
pls <- read.table('../../processed_data/combined/20191114_kmer_pls_classification_predictions.txt',
                       col.names = c('predicted', 'observed'))
...
```{r}
rf <- read.table('../../processed_data/combined/20191114_rf_tss_scramble_peak_classification_predictions.txt',
                              col.names = c('predicted', 'observed'))
...
```{r}
rf_onehot <- read.table('../../processed_data/combined/20191114_rf_onehot_tss_scramble_peak_classification_predictions.txt',
                              col.names = c('predicted', 'observed')) %>% 
...
```{r}
mlp <- read.table('../../processed_data/combined/20191114_mlp_tss_scramble_peak_predictions_classification.txt',
                  col.names = c('predicted', 'observed'))
...
```{r}
mlp_3to6 <- read.table('../../processed_data/combined/20191114_mlp_3to6mer_tss_scramble_peak_predictions_classification.txt',
                  col.names = c('predicted', 'observed'))
...
```{r}
nn <- read.table('../../processed_data/combined/20191114_tss_scramble_peak_classification_hyperparam_tuned_predictions.txt',
                 col.names = c('predicted', 'observed'))
