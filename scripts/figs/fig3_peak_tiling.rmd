...
```{r, eval = F}
roc_info <- read.table('../../processed_data/peak_tile/model_files/20190423_peak_tile_classifier_hyperparam_tuned_roc_info.txt',
...
ggsave('../../figs/fig3/peak_tile_roc.pdf', units = 'in', width = 4, height = 4)
```

```{r, eval = F}
pr_info <- read.table('../../processed_data/peak_tile/model_files/20190423_peak_tile_classifier_hyperparam_tuned_pr_info.txt',
                      sep = ',', col.names = c('precision', 'recall', 'threshold'))


auprc <- pracma::trapz(pr_info$precision, pr_info$recall)

ggplot(pr_info, aes(recall, precision)) + geom_line() +
    scale_x_continuous(breaks = c(0.00, 0.25, 0.50, 0.75, 1.00)) +
    annotate('text', x = 0.90, y = 0.15, label = 'AUC = 0.635') +
    theme(aspect.ratio = 1)

ggsave('../../figs/fig3/peak_tile_pr.pdf', units = 'in', width = 4, height = 4)
```
...
```{r, eval = F}
reg_predictions <- read.table('../../processed_data/peak_tile/model_files/20190422_peak_tile_hyperparam_tuned_predictions.txt',
