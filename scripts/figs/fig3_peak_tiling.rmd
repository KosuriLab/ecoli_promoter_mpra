...
```{r}
roc_info <- read.table('../../processed_data/peak_tile/20190423_peak_tile_classifier_hyperparam_tuned_vtwo_roc_info.txt',
...
```{r}
pr_info <- read.table('../../processed_data/peak_tile/20190423_peak_tile_classifier_hyperparam_tuned_vtwo_pr_info.txt',
